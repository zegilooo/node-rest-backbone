 ...
 * passport-google.js
 *
 * Passport setup for Google OAUTH authentication. Go here to configure client credentials: https://code.google.com/apis/console.
 */
					...
					if(olduser) {
						...
						User.findOne({ 'email': profile.emails[0].value }, function(err, olduser) {
							...
							if (olduser) {
								...
								// right thing to do?
								account = { provider: "google", uid: profile.id };
